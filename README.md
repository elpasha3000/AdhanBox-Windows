...
- **[Download AdhanBox_0.4_Windows_x64.zip](https://github.com/elpasha3000/AdhanBox-Windows/releases/latest)** — portable, no installer: unzip and run `AdhanBox.exe`
- **[Microsoft Store](https://apps.microsoft.com/detail/9php7qsvq829)** — recommended: signed by Microsoft, updates automatically
- **Build from source** — see below

> The portable exe is not code-signed, so Windows SmartScreen may warn on first run: click **More info → Run anyway**. The Store version is signed by Microsoft and has no warning.
...
- **[حمّل الزيب من هنا](https://github.com/elpasha3000/AdhanBox-Windows/releases/latest)** — نسخة محمولة من غير تثبيت: فكّ الضغط وشغّل `AdhanBox.exe`
